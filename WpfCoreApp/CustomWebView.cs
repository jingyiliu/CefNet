...
namespace WpfCoreApp
{
	...
	{
		public static RoutedEvent FullscreenEvent = EventManager.RegisterRoutedEvent("Fulscreen", RoutingStrategy.Bubble, typeof(EventHandler<FullscreenModeChangeEventArgs>), typeof(WebView));
